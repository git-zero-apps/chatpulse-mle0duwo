  ...
  return {
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <h1 style="font-size: 24px; font-weight: 700; color: #111; margin-bottom: 16px;">Welcome to ChatPulse 🎉</h1>
        ...
        <p style="font-size: 14px; color: #999; margin-top: 32px;">— The ChatPulse Team</p>
      </div>
    `,
  };
}
...
export function object_ObjectEmail(data: Record<string, string>): { subject: string; html: string } {
  return {
    subject: `ChatPulse: [Object Object]`,
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
