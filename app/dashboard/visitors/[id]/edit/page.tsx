  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          <label htmlFor="session_id" className="label">Session Id</label>
          <input id="session_id" name="session_id" type="text" className="input" defaultValue={String(record.session_id ?? "")} />
        </div>
