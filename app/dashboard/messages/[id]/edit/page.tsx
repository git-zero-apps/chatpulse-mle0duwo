    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div className="flex items-center gap-3">
          <input id="is_read" name="is_read" type="checkbox" defaultChecked={!!record.is_read} className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500" />
          <label htmlFor="is_read" className="text-sm font-medium text-gray-700">Is Read</label>
        </div>
        <div>
